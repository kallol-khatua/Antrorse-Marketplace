      ...
      <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="mt-4 text-base text-gray-700">
            Experience the pure essence of tree extracts products without any
            chemicals or wax with floral herbal fragrances.
          </p>
        </div>
          ...
          <article className="relative">
            ...
            <Link to="/viewproducts" title="" className="cursor-pointer">
              ...
              <div className="mt-4 flex items-start justify-between">
                <div className="">
                  <h3 className="text-xs font-semibold sm:text-sm md:text-base">
                    <a href="" title="/viewproducts" className="cursor-pointer">
                      Metallic Agarbatti
                      <span className="absolute" aria-hidden="true"></span>
                    </a>
                  </h3>
