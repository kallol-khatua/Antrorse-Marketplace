...
const SellerSidebar = () => {
  ...
  const handleLogout = () => {
    dispatch(setSellerAuth(false));
    localStorage.removeItem("isAuthorizedSeller");
  ...
  return (
    <div className="h-[100%]">
      <aside className="absolute left-0 top-0 z-9999 h-full flex bg-teal-700 flex-col overflow-hidden duration-300 ease-linear dark:bg-slate-800 lg:static lg:translate-x-0 w-60">
            ...
            <div>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {/* <SidebarLinkGroup>
                  <React.Fragment> */}
                {/* <NavLink
                  to="/seller/help-and-support"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-200 cursor-pointer duration-300 ease-in-out hover:bg-teal-800 dark:hover:bg-gray-600-4 text-lg`}
                  //  ${
                ...
                <NavLink
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-200 duration-300 ease-in-out hover:bg-teal-800 dark:hover:bg-gray-600-4 text-lg  cursor-pointer `}
